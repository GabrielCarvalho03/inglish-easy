...
export const Possibility = forwardRef<HTMLDivElement, {}>((_, ref) => {
  return (
    <main ref={ref} className="w-full flex flex-col-reverse lg:flex-row justify-between lg:pl-40">
      <section className="lg:-ml-28 mb-10 md:mb-0 flex justify-center items-center ml-10 mt-10">
        <div className="flex flex-col">
          <ColorBar color="primary" />
          <h1 className="font-extrabold text-2xl">É possível aprender com uma IA?</h1>
          <div>
            <p className="text-gray-400 w-8/12">
              Com certeza! A Inteligência Artificial ajusta-se ao seu ritmo, identifica suas necessidades e torna
              o aprendizado mais eficaz e envolvente.
            </p>
          </div>
        </div>
      </section>
